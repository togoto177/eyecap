...
<div id="wrapper">
        ...
        <div class="sub-main-content">
            ...
            <section class="section" id="sub-section-3">
            	<div class="btnDiv">
            		<a class="btnCap" href="pop02.do">CertificateCAP</a><a class="btnCap" id="priceBtn">PriceListCap</a><a class="btnCap" href="/resources/sub/A/test/CAPspecification.xlsx" target="_blank">Specification&darr;</a>
            	</div>
                    ...
                    <ul class="sub_des_box02">
                        <li class="widthFull2">
                            <div class="leftBox_3">
	                            ...
	                            <img style="width: 90%;" alt="img" src="resources/sub/A/test/103.jpg">
	                            </div>
	                            <p class="sitText">
                   ...
                   <div class="sub_wrapper">
                    ...
                    <ul class="sub_des_box02">
                        <li class="widthFull2">
                            <div class="leftBox_3">
	                            <div style="width: 100%; text-align: center;">
	                            <img style="width: 75%;" alt="img" src="resources/sub/A/test/104.jpg">
	                            </div>
	                            <p class="sitText">
	                            	※T - Average thickness ±10%. All other dimensions are restricted to ±15% tolerance. Specification may change without prior notification for better performance.
	                            </p>
                   ...
                   <div class="sub_wrapper">
                    ...
                    <ul class="sub_des_box02">
                        <li class="widthFull2">
                            <div class="leftBox_3">
	                            <div style="width: 100%; text-align: center;">
	                            <img style="width: 90%;" alt="img" src="resources/sub/A/test/105.jpg">
	                            </div>
	                            <p class="sitText">
	                            	※T - Average thickness ±10%. All other dimensions are restricted to ±15% tolerance. Specification may change without prior notification for better performance.
	                            </p>
                   ...
                   <div id="sub_product_function" style="background:#f7f7f7;">
                        <div class="sub_wrapper">
                        	...
                        	<img class="one_img" alt="img" src="resources/sub/A/test/106.jpg">
                        	</div>
