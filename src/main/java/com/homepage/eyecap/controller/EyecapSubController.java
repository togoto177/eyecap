...
public class EyecapSubController {
	...
	@RequestMapping(value = "/pop01.do")
	public String pop1(Pro_log pro_log, HttpServletRequest request) {
		...
		return "sub/A_Cable Connectors/01_pop";
	}
	...
	@RequestMapping(value = "/pop03.do")
	public String pop3(Pro_log pro_log, HttpServletRequest request) {
		...
		return "sub/A_Cable Connectors/03_pop";
	}
